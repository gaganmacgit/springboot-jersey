...
public class UserResource {
	...
	public Response attachupload(@FormDataParam("file") InputStream is,
			@FormDataParam("file") FormDataContentDisposition fileDetail, @FormDataParam("fileName") String flename) {
	...
	public Users getAllUsers() {
		count+=1;
		System.out.println(" count in users "+ count + " user mode in pathparam is "+userMode);
